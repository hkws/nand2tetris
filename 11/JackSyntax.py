...
def isMethod(bodies):
    if isinstance(bodies, list) and len(bodies) == 1:
        if "keyword" in bodies[0] and bodies[0]["keyword"] == "method":
            return True
    return False        
...
SYMBOL = {
    ...
    "postprocess": [
        ...
        {"func": "addVar",
         "target": "varDec"},
        {"func": "referSymbolInTerm",
         "target": "term"},
        {"func": "referSymbolInLetStatement",
         "target": "letStatement"},
        {"func": "referSymbolInSubroutineCall",
         "target": "subroutineCall"},
        {"func": "editClassNameObj",
         "target": "className"},
        {"func": "addDummyArgumentForMethod",
         "target": isMethod},
        {"func": "editSubroutineNameObj",
         "target": "subroutineName"},
        {"func": "editSubroutineDecObj",
         "target": "subroutineDec"},
        {"func": "endScope",
         "target": "subroutineDec"},
        {"func": "editClassObj",
...
SYMBOL["preprocess_targets"] = [proc["target"] for proc in SYMBOL["preprocess"]]
SYMBOL["postprocess_targets"] = [proc["target"] for proc in SYMBOL["postprocess"]]
